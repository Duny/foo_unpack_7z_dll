...
DECLARE_COMPONENT_VERSION ("7z Archive Unpacker", "3.2 beta 2",
...
namespace unpack_7z
{
    namespace cfg
    {
        ...
        cfg_bool   cache_clear_at_exit (guid_inline<0x603e6f84, 0x70ee, 0x4e9a, 0xab,0x0a, 0xa9, 0xd2, 0xf9, 0x07, 0x59, 0xdd>::guid, defaults::cache_clear_at_exit);
